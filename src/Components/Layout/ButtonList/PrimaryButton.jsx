...
const PrimaryButton = ({ text, className, slug , icon , disabled}) => {
  ...
  return (
    <div
      ...
      disabled={disabled}
      className={`text-[11px] sm:text-[12px] md:text-sm lg:text-base text-center px-1 sm:px-[2px] md:px-5 py-[4px] sm:py-[6px] md:py-[6px] lg:py-2 rounded-full  bg-theme text-secondary hover:bg-buttonHover cursor-pointer
