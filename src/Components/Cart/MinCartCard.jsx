...
const MinCartCard = ({
    ...
    return (
        <div className="">
            <div
                className={`bg-secondary grid grid-cols-1 grid-cols-12 gap-[6px] sm:gap-2 md:gap-2 lg:gap-4 items-center pb-2 sm:pb-4 md:pb-5 ${isLastItem ? "" : "border-b-[1px]"
                    } border-borderColor`}
            >
                {/* Product Image */}
